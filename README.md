...
| Empty shopping list | Turn bedroom lights off |
|---------------------|-------------------------|
|<img src="https://github.com/moostmartijn/homeassistant/blob/master/docs/images/ios_actionable_shopping_list.jpg" alt="Actionable iOS notification - Empty shopping list" width="200"/>| <img src="https://github.com/moostmartijn/homeassistant/blob/master/docs/images/ios_actionable_lights_off.jpg" alt="Actionable iOS notification - Turn bedroom lights off" width="200"/>|
